...
export const highlight = (word, query = '') => {
  ...
  tokens.forEach((token) => {
    word = word.replace(new RegExp('/' + token + ')/gi', '<strong style="color: black;background-color: #d7d7d7;">$1</strong>')
