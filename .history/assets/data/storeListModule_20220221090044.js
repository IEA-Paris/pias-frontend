...
export const baseState = (type) => {
  ...
  return {
    ...
    skip: 0,
    limit: lists[type].perPage.default,
    search: '',
    page: 1,
    view: defaultView.name,
    sortBy: [defaultSort[0].value[0]],
    sortDesc: [defaultSort[0].value[1]],
    numberOfPages: 0,
    itemsPerPage: lists[type].perPage.default,
    itemsPerPageArray: lists[type].perPage.options,
    filtersCount: 0,
  }
}
...
export const baseActions = {
  ...
  async update({ dispatch, commit, state, getters }, value = {}) {
    ...
    console.log('getters.defaultSort: ', getters)
