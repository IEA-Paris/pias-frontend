...
export const baseState = (type) => {
  ...
  return {
    ...
    sortBy: [defaultSort.value[0]],
    sortDesc: [defaultSort.value[1]],
    numberOfPages: 0,
    itemsPerPage: lists[type].itemsPerPage,
    itemsPerPageArray: lists[type].itemsPerPageArray,
    filtersCount: 0,
  }
}
...
export const baseActions = {
  ...
  async update({ dispatch, commit, state, getters }, value = {}) {
    ...
    console.log('getters.defaultSort: ', getters.defaultSort)
