...
export default {
  ...
  data() {
    return {
      podcast: false,
      socials: [
        ...(thi.item.social_channels.website
          ? [
              {
                link: thi.item.social_channels.website,
                icon: 'mdi-link-variant',
                tooltip: 'Visit this author website', // TODO i18n
              },
            ]
          : []),
        ...(thi.item.social_channels.wikipedia
          ? [
              {
                link: thi.item.social_channels.wikipedia,
                icon: 'mdi-wikipedia',
                tooltip: 'Check the Wikipedia page of the author',
              },
            ]
          : []),
        ...(thi.item.social_channels.orcid
          ? [
              {
                link: thi.item.social_channels.orcid,
                icon: 'mdi-account',
                tooltip: 'Visit the author Orcid page',
              },
            ]
          : []),
        ...(thi.item.social_channels.google_scholar
          ? [
              {
                link: thi.item.social_channels.google_scholar,
                icon: 'mdi-google',
                tooltip: 'Visit the author Google Scholar page',
              },
            ]
          : []),
        ...(thi.item.social_channels.mendeley
          ? [
              {
                link: thi.item.social_channels.mendeley,
                icon: 'mdi-school',
                tooltip: 'Visit the author Mendeley page',
              },
            ]
          : []),
        ...(thi.item.social_channels.researchgate
          ? [
              {
                link: thi.item.social_channels.researchgate,
                icon: 'mdi-flask',
                tooltip: 'Visit the author Researchgate page',
              },
            ]
          : []),
        ...(thi.item.social_channels.linkedin
          ? [
              {
                link: thi.item.social_channels.linkedin,
                icon: 'mdi-linkedin',
                tooltip: 'Get in touch on Linkedin',
              },
            ]
          : []),
        ...(thi.item.social_channels.twitter
          ? [
              {
                link: thi.item.social_channels.twitter,
                icon: 'mdi-twitter',
                tooltip: 'Follow this author on Twitter',
              },
            ]
          : []),
        ...(thi.item.social_channels.instagram
          ? [
              {
                link: thi.item.social_channels.instagram,
                icon: 'mdi-instagram',
