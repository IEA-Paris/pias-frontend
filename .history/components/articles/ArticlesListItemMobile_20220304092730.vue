<template>
  ...
  >
    ...
    >
      ...
      </TextFingerprint> </v-list-item-avatar
    ><v-list-item-content>
      <v-list-item-title class="article-mobile-title">
        <div>
          <ArticleCategories
      ...
      <v-list-item-subtitle class="d-inline-flex mt-3">
        <template
          v-if="$vuetify.breakpoint.xs || ($vuetify.breakpoint.sm && filter)"
        >
          {{
