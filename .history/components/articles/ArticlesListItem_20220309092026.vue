  ...
  <div class="transition-swing">
    ...
    >
      ...
      >
        ...
        <v-skeleton-loader type="paragraph" height="100%"></v-skeleton-loader>
        <v-skeleton-loader type="button" tile height="100%"></v-skeleton-loader>
      </div>
    </v-card>
    <v-card
      v-else
