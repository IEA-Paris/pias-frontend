<template>
  <div class="frame">
    <template v-if="$store.state.loading || true">
      <div class="overlay">
        <div class="top">
          ...
          <span v-if="hasContent('caption')" class="">
            <div class="my-4 px-3 caption-content-frame"></div>
          </span>
          <div v-if="hasContent('author')" class="caption-author"></div>
        </div>
