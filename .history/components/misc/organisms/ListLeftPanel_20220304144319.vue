    ...
    >
      ...
      >
        <v-container
          ...
          :class="{ 'px-0': $store.state.scrolled && $vuetify.breakpoint.xs }"
        >
          <v-row
      ...
      >
        <v-row class="transition-swing pl-3 pr-0 fill-height">
          <v-col cols="12 " :class="filtersSpacing">
    ...
    >
      ...
      <div class="text-center">
        <v-pagination
          ...
          @input="
            $store.dispatch(type + '/updatePage', $event) && $vuetify.goTo(0)
          "
        ></v-pagination>
      </div>
    </v-container>
  ...
  computed: {
    filtersSpacing() {
      ...
      switch (this.$vuetify.breakpoint.name) {
        case 'sm':
          return scrolled ? 'mt-14 pt-11 pr-3' : 'mt-14 pt-9 pr-0'

        case 'md':
          return scrolled ? 'mt-14 pt-12 pr-3' : 'mt-12 pt-11 pr-0'

        case 'lg':
          return scrolled ? 'mt-12 pt-10 pr-2' : 'mt-12 pt-8 pr-0'

        case 'xl':
          return scrolled ? 'mt-12 pt-10 pr-3' : 'mt-12 pt-8 pr-0'

        default:
          return 'mt-12 pt-10 pr-3'
      }
    },
    view() {
