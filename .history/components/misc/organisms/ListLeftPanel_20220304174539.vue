    ...
    >
      ...
      <div class="text-center">
        <v-pagination
          ...
          @input="
            $store.dispatch('updatePage', $event, type) && $vuetify.goTo(0)
          "
        ></v-pagination>
      </div>
    </v-container>
...
export default {
  ...
  data() {
    return {
      ...
      debouncedSearch: debounce(function (v) {
        this.$store.dispatch('updateSearch', v, this.type)
        this.$vuetify.goTo(0)
      }, 200),
    }
  },
  ...
  computed: {
    ...
    itemsPerPage: {
      ...
      async set(v) {
        await this.$store.dispatch('updateItemsPerPage', {value:v, type this.type})
        this.$vuetify.goTo(0)
      },
    },
    options: {
  ...
  async mounted() {
    ...
    await this.$store.dispatch('update', { type: this.type })
  },
  updated() {},
  methods: {
