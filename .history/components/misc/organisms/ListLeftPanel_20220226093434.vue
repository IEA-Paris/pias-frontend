  ...
  <div>
    ...
    <v-row no-gutters class="mt-n12">
      <v-col cols="12" class="d-flex">
        <div v-if="$vuetify.breakpoint.smAndUp" class="sidebtn">
          <v-tooltip bottom>
    ...
    >
      ...
      <v-col
        v-if="$vuetify.breakpoint.mdAndUp && filter"
        :cols="filter ? 2 : 1"
        :xl="filter ? 2 : 1"
        :lg="filter ? 3 : 1"
        :md="filter ? 3 : 1"
...
export default {
  ...
  methods: {
    mobileCheck() {
      ...
      if (this.$vuetify.breakpoint.mdAndDown) this.filter = false
    },
