...
export const actions = {
  async resetState({ dispatch, commit, state }, value, type, rootState) {
    commit('setBlankState')
    commit('setPage', 1)
    await dispatch('update')
  },
  async updateSort({ dispatch, commit, state }, value, type, rootState) {
    commit('setSort', value)
    commit('setPage', 1)
    await dispatch('update')
  },
  async updateView({ dispatch, commit, state }, value, type, rootState) {
    commit('setView', value)
    await dispatch('update')
  },
  async updateFilters({ dispatch, commit, state }, value, type, rootState) {
  ...
  async updatePage({ dispatch, commit, state }, page, type, rootState) {
    commit('setPage', page)
    await dispatch('update')
  },
  async updateSearch({ dispatch, commit, state }, search, type, rootState) {
    commit('setPage', 1)
