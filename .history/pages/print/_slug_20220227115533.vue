      ...
      <tbody>
        <tr>
          <td>
            ...
            <div class="overline mt-6 mb-3">{{ $t('publication-date') }}</div>
            <div class="mb-6">
              {{
            ...
            <template v-if="item.tags && item.tags.length">
              <div class="overline mt-6 mb-3">{{ $t('keywords') }}</div>
...
export default {
  ...
  computed: {
    formatedAuthors() {
      return formatAuthors(this.item.authors, this.$i18n.$t, this.full)
    },
  },
  mounted() {},
  methods: {},
