...
resource "aws_cloudfront_distribution" "this" {
  ...
  aliases             = var.env == "prod" ? ["pias.science"] : []
  ...
  viewer_certificate {
    acm_certificate_arn            = var.env == "prod" ? "arn:aws:acm:us-east-1:720928668014:certificate/6410e59c-599e-4ef8-ad49-b4eedd26c635" : null
